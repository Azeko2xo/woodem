...
struct RadialForce: public Engine {
	bool acceptsField(Field* f){ return dynamic_cast<DemField*>(f); }
	virtual void run();
	virtual void postLoad(RadialForce&,void*){ axisDir.normalize(); }
	WOO_CLASS_BASE_DOC_ATTRS(RadialForce,Engine,"Apply force of given magnitude directed away from spatial axis on some nodes.",
