...
struct Gl1_DemField: public GlFieldFunctor{
	...
	enum{COLOR_NONE=0,COLOR_RADIUS,COLOR_VEL,COLOR_DISPLACEMENT,COLOR_ROTATION};
	...
	WOO_CLASS_BASE_DOC_STATICATTRS_PY(Gl1_DemField,GlFieldFunctor,"Render DEM field.",
		...
		((int,colorBy,COLOR_NONE,AttrTrait<Attr::triggerPostLoad>().choice({{COLOR_NONE,"nothing"},{COLOR_RADIUS,"radius"},{COLOR_VEL,"velocity"},{COLOR_DISPLACEMENT,"displacement"},{COLOR_ROTATION,"rotation"}}),"Color particles by"))
