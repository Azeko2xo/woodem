...
struct BoxFactory: public RandomFactory{
	Vector3r randomPosition() WOO_CXX11_OVERRIDE { return box.sample(); }
...
struct CylinderFactory: public RandomFactory{
	Vector3r randomPosition() WOO_CXX11_OVERRIDE; /* http://stackoverflow.com/questions/5837572/generate-a-random-point-within-a-circle-uniformly */
