...
struct FlexFacet: public Facet{
	...
	DECLARE_LOGGER;
		...
		#define woo_dem_FlexFacet__ATTRS__FLEXFACET_DEBUG_ROT \
	...
	#define woo_dem_FlexFacet__CLASS_BASE_DOC_ATTRS_CTOR_PY \
		...
		woo_dem_FlexFacet__ATTRS__FLEXFACET_DEBUG_ROT \
		,/*ctor*/ createIndex(); \
		,/*py*/ \
	...
	WOO_DECL__CLASS_BASE_DOC_ATTRS_CTOR_PY(woo_dem_FlexFacet__CLASS_BASE_DOC_ATTRS_CTOR_PY);
};
...
struct In2_FlexFacet_ElastMat: public IntraFunctor{
	...
	DECLARE_LOGGER;
	#define woo_dem_In2_FlexFacet_ElastMat__CLASS_BASE_DOC_ATTRS \
		In2_FlexFacet_ElastMat,IntraFunctor,"Apply contact forces and compute internal response of a :obj:`FlexFacet` (so far only the plane stress element has been implemented).", \
...
struct Gl1_FlexFacet: public Gl1_Facet{	
	...
	RENDERS(FlexFacet);
	WOO_CLASS_BASE_DOC_STATICATTRS(Gl1_FlexFacet,Gl1_Facet,"Renders :obj:`FlexFacet` object; :obj:`Facet` itself is rendered via :obj:`Gl1_Facet`.",
