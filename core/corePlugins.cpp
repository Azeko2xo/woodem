...
WOO_PLUGIN(core,(Cell)(Dispatcher)(EnergyTracker)(Engine)(Functor)(GlobalEngine)(ParallelEngine)(PartialEngine)(PeriodicEngine)(Plot)(PyRunner)(DisplayParameters)(WooTestClass));
