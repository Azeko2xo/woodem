...
O.engines=[
	...
	BoxFactory(maxParticles=10000,extents=(8e-3,8e-3,8e-3),center=(0,-15e-3,15e-3),rMin=0.28e-3,rMax=0.29e-3,vMin=100,vMax=100,vAngle=0,massRate=100./60,normal=(0,1.5,-1),label='factory',materialId=shotsId),
