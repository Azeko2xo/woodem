...
<script type="text/x-mathjax-config">\
  MathJax.Hub.Config({\
    TeX: {\
      Macros: {\
        prev:["#1^-",1],pprev:["#1^{\\\\ominus}",1],curr:["#1^{\\\\circ}",1],nnext:["#1^{\\\\oplus}",1],next:["#1^{+}",1],Dt:"\\\\Delta t",tens:["\\\\boldsymbol{#1}",1],vec:["\\\\boldsymbol{#1}",1],mat:["\\\\boldsymbol{#1}",1],u:["\\\\,\\\\mathrm{#1}",1],normalized:["\\\\frac{#1}{|\\\\cdot|}",1],d:"\\\\mathrm{d}\\\\,",phi:"\\\\varphi",\
      }\
    }\
  });\
</script>')
