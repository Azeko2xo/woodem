# -*- coding: utf-8 -*-
#
# downloaded from https://raw.github.com/ipython/ipython/master/docs/sphinxext/ipython_directive.py
# since it is not in python-matplotlib anymore, and not yet in the ipython package
#
#
