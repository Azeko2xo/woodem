...
BOOST_PYTHON_MODULE(_utils2){
	...
	py::def("contactCoordQuantiles",DemFuncs::contactCoordQuantiles,(py::arg("dem"),py::arg("quantiles"),py::arg("pt"),py::arg("dir")),"Return list of contact coordinates at given quantile values, measured along the *dir* axis starting from point *pt*.");
}
