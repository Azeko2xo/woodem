...
BOOST_PYTHON_MODULE(_utils2){
	...
	py::def("mapColor",CompUtils::scalarOnColorScale,(py::arg("x"),py::arg("min")=0,py::arg("max")=1,py::arg("cmap")=-1,py::arg("reversed")=false),"Map scalar to color (as 3-tuple). See :ref:`woo.core.Master.cmap`, :ref:`woo.core.Master.cmaps` to set colormap globally.");
