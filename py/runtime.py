...
try: # attempt to get numerical version
	...
	elif IPython.__version__.startswith('1.2'): ipython_version=120
	...
	ipython_version=13
if ipython_version not in (10,11,12,13,100,110,120): # versions that we are able to handle, round up or down correspondingly
	newipver=10 if ipython_version<10 else 110
